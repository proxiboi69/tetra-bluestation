...
/// Clause 20.4.3 and 20.3.5.4.1c
/// TMC-CONFIGURE request, MAY BE USED BY LLC, see below. When used by MLE: 
...
/// 
/// When used by LLC: this primitive shall be used to accept or reject a channel change. It is also used for the
